...
namespace
{
	...
	const char* const WINDOW_TITLE = "7-1 FinalProject and Milestones|Brad Wells"; 
...
int main(int argc, char* argv[])
{
	...
	std::cout << "O - orthogrpahic\n";
	std::cout << "P - perspective\n";
	std::cout << "\n*** MOUSE FUNCTIONS: ***\n";
	std::cout << "Scroll Up - Decrease Speed\n";
	std::cout << "Scroll Down - Increase Speed\n";
